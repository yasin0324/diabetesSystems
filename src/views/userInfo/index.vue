    ...
    <div class="main">
        <div class="head">
            <el-row>
                <el-col :span="4">
                    <div class="header">
                        <el-avatar :src="UserNewsValue.avatar" :size="120" />
                    </div>
                </el-col>
                <el-col :span="12">
                    <div class="userNews">
                        <el-row>
                            <el-col :span="20">
                                <h3>昵称：{{ UserNewsValue.nickName }}</h3>
                                <p>
        ...
        <div class="BannerAllUser">
            <div class="userNews">
                <h1>
                    已关联账号<el-icon><CopyDocument /></el-icon>
                </h1>
                <div class="margin-top">
                    <el-button
                        ...
                        plain
                        style="float: right"
                        @click="Addassociated(1)"
                        >新增关联账号</el-button
                    >
                    <el-row>
                        <el-col
                            :span="6"
                            v-for="(item, index) in AllUserValue"
                            :key="index"
                        >
                            <div class="User">
                                <div class="avatar">
            ...
            <div v-show="showuserNameLogin" class="center">
                ...
                >
                    <el-form-item label="账号:" prop="userName">
                        <el-input
                            v-model="UserNamePassLogin.userName"
                            placeholder="请输入账号"
                            style="flex: 1"
                        />
                    </el-form-item>
                    <el-form-item label="密码:" prop="password">
                        <el-input
                            v-model="UserNamePassLogin.password"
                            placeholder="请输入密码"
                            style="flex: 1"
                            show-password
                        />
            ...
            <div v-show="showmobileLogin" class="center">
                ...
                >
                    <el-form-item label="手机号:" prop="mobile">
                        <el-input
                            v-model="UsermobileValue.mobile"
                            placeholder="请输入手机号"
                            style="flex: 1"
                        />
                    </el-form-item>
                    ...
                    >
                        <el-input
                            v-model="UsermobileValue.smsCode"
                            placeholder="请输入验证码"
                            style="flex: 1"
                        />
                        <el-button
        ...
        <el-dialog
            ...
            class="captchaDialog"
            show-close="false"
            style="background: transparent; box-shadow: none; margin: 25vh auto"
        >
...
const postAddmobile = () => {
    dialogAddassociated.value = false;
    putAddMobileConnection(UsermobileValue.value).then((res) => {
        ElMessage({
            message: "添加关联成功",
            type: "success",
        });
...
.main {
    ...
    .head {
        ...
        box-shadow: -3px 3px 5px rgba(0, 0, 0, 0.1),
            3px 3px 5px rgba(0, 0, 0, 0.1), 0 3px 5px rgba(0, 0, 0, 0.1);
        .el-row {
            padding: 1%;
            width: 100%;
            height: 100%;
